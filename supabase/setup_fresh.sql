...
-- Complete schema, RLS policies, and RPC functions
--
-- This script is intended for fresh installations.
-- Do NOT run on a production system with existing data.
--
-- Run this once in Supabase SQL Editor for initial setup.
-- ============================================================

-- ============================================================
-- 1. DROP OLD TABLES (if exist - for clean setup)
-- ============================================================
...
-- 2. Disable "Confirm email" (invite-only system)
-- 3. Enable "Auto Confirm" for new users
-- 4. Create your admin user:
--    a) Authentication → Users → Add User (email + password)
--    b) Get your user_id from auth.users
--    c) Run: INSERT INTO admin_users (user_id) VALUES ('your-user-id');
--    d) Run: INSERT INTO allowed_users (email) VALUES ('your-email@example.com');
